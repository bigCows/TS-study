...
// any：任意类型，
var anys = 1;
console.log(anys.toString());
// unknown 未知类型 any类型的替代者，可被赋值为任意类型 
var unknowns = 1222;
unknowns = 2;
unknowns = '123';
unknowns = true;
...
unknowns = [];
unknowns = {};
console.log(unknowns.toString());
// let fa = (config:Ifa) => {
//     const {flagA,flagB} = config
//     console.log(flagA,flagB);
// }
var fa = function (config) {
    var flagA = config.flagA, flagB = config.flagB;
    console.log(flagA, flagB);
};
fa({ flagA: true, flagB: false });
var ner;
var TT = function () {
    throw new Error('xxx');
};
